...
const benefits = [
  ...
  { icon: Shield, title: 'End-to-End Warranty Documentation', desc: 'Every SunTek PPF install at Next LVL Protection includes manufacturer warranty documentation — SunTek Reaction PPF (12-year warranty) and SunTek Ultra Matte PPF (10-year warranty). Installer certification reference, installation date, and panel coverage record all provided at handover.' },
];
...
const faqs = [
  ...
  { q: 'What SunTek products does Next LVL Protection install?', a: 'Next LVL Protection installs SunTek Reaction PPF (gloss, 12-year warranty) and SunTek Ultra Matte PPF (10-year warranty) on all applicable packages. Window tinting at Next LVL Protection is performed with Solar Gard products — not SunTek window film — as our window tinting line is a separate authorisation.' },
      ...
      <section ref={heroRef} style={{ position: 'relative', height: '100dvh', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', padding: '0 8vw 10vh' }}>
        ...
        <div ref={heroContentRef} style={{ position: 'relative', zIndex: 2 }}>
          ...
          <p className="hero-anim" style={{ color: 'var(--color-text-secondary)', fontSize: 'clamp(15px, 2vw, 18px)', marginTop: 20, maxWidth: 560 }}>
            Next LVL Protection is a SunTek Authorised Application Centre in Brisbane. SunTek Reaction PPF — 12-year manufacturer warranty, ceramic-infused self-healing topcoat, optically clear finish.
          </p>
