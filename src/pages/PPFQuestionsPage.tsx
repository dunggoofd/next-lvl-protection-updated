...
const faqs = [
  ...
  { q: 'Is there a warranty on PPF?', a: 'SunTek Reaction PPF carries a 12-year manufacturer warranty covering yellowing, cracking, bubbling, and delamination. SunTek Ultra Matte carries a 10-year warranty. Next LVL Protection backs all installations with our own workmanship guarantee. Warranty documentation is provided at handover.' },
  ...
  { q: 'Does Next LVL Protection use SunTek or XPEL PPF?', a: 'Next LVL Protection is a SunTek Authorised Installer. Our primary PPF range is SunTek Reaction (Gloss, 12-year warranty) and SunTek Ultra Matte (10-year warranty). We also have access to the Solar Gard film range for specific applications.' },
];
